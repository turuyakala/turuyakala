                ...
                <tr key={message.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                    <button
                      ...
                      className="text-[#563C5C] hover:text-[#563C5C]/80"
                    >
                      👁️ Görüntüle
                    </button>
                    {message.status === 'new' && (
                  ...
                  <div>
                    ...
                    <div className="mt-3 flex gap-2">
                      <button
                        ...
                        className="px-4 py-2 bg-[#563C5C] text-white rounded-md hover:bg-[#563C5C]/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                      >
